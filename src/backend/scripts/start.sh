...
echo "  3. MinIO (Object Store)  (Port 9000, Console 9001)"
echo "  4. Eureka Server         (Port 8761)"
echo "  5. Auth Service          (Port 8081)"
echo "  6. Driver Service        (Port 8082)"
echo "  7. Company Service       (Port 8083)"
echo "  8. Campaign Service      (Port 8084)"
echo "  9. Ride Service          (Port 8085)"
echo " 10. Gateway Service       (Port 8080) ← Main API Entry"
echo ""
