...
public class RideStatisticsResponse {
    ...
    public RideStatisticsResponse(Long totalRides, Long completedRides, Long verifiedRides,
                                  Integer totalDurationSeconds, Integer averageDurationSeconds,
                                  Long activeRidesCount, Double totalDistanceKm,
                                  Double weeklyDistanceKm, Double monthlyDistanceKm,
                                  Double totalEarnings, Double weeklyEarnings,
