...
public class CampaignRideStatsResponse {
    ...
    public CampaignRideStatsResponse() {
    }

    public CampaignRideStatsResponse(Long campaignId, long totalRides, double totalDistanceKm,
